...
- Release PRs opened by release-plz only auto-merge when they carry the
  `autorelease` label. Add the label to queue the PR to merge once CI is green;
  without it the PR stays open until merged by hand.
